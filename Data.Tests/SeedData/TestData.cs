...
public static class TestData
{
    ...
    public static readonly UserEntity[] UsersEntities = [
        new UserEntity { Id = 1, FirstName = "Björn", LastName = "Åhström", Email = "bjorn.ahstrom@icloud.com", RoleId = 1, Role = RolesEntities[0], UserRoles = new List<UserRoleEntity> { UserRoleEntities[0] }},
        new UserEntity { Id = 2, FirstName = "Desirèe", LastName = "Åhström", Email = "desiree.ahstrom@icloud.com", RoleId = 2, Role = RolesEntities[1], UserRoles = new List<UserRoleEntity> { UserRoleEntities[1] }}
    ];
